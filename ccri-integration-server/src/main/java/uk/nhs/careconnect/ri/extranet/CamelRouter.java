...
import uk.nhs.careconnect.ri.extranet.camel.GatewayCamelPostProcessor;
import uk.nhs.careconnect.ri.extranet.camel.GatewayCamelProcessor;
...
public class CamelRouter extends RouteBuilder {
    ...
    public void configure()
    {
        ...
        from("direct:FHIRObservation")
                .routeId("Extranet Observation")
                .to("direct:HAPIServer");

        from("direct:FHIRMedicationRequest")
                .routeId("Extranet MedicationRequest")
                .to("direct:HAPIServer");

        from("direct:FHIRProcedure")
                .routeId("Extranet Procedure")
                .to("direct:HAPIServer");
